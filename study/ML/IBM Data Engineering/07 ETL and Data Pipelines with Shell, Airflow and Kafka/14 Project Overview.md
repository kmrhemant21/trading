...
## How to submit
You will need to submit a screenshot in the JPEG or PNG format for all tasks. The screenshots will be uploaded in the submission step of the final project. You will be prompted to save screenshots throughout the labs and these will be the files you submit during the Project Submission and Peer Review section of this course.
