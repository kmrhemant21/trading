...
- **Big Data processing technologies** help derive value from big data. These include:
    - NoSQL databases
    - Data Lakes
    - Open-source technologies such as Apache Hadoop, Apache Hive, and Apache Spark

- **Hadoop** provides distributed storage and processing of large datasets across clusters of computers. One of its main components, the Hadoop File Distribution System (HDFS), is a storage system for big data.
